...
export default function PresentationPage() {
    ...
    if (view === 'graph') {
        return <NodeGraph
            ...
            onOpenInfographic={() => router.push('/inu-score/infographic')}
                ...
                >
                    ...
                    <div className={styles.slide}>
                        <div style={{ width: '100%', maxWidth: '1000px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4rem', marginTop: '2rem' }}>
                            ...
                            <h1 className={styles.mainTitle} style={{ fontFamily: '"garamond-premier-pro", serif', fontSize: '24px', fontWeight: 400, color: '#111' }}>
