            ...
            >
                ...
                <div className={styles.slide}>
                    <div className={`${styles.chapterLayout} ${styles.chapterLayoutCompact}`}>
                        ...
                        <div className={styles.chapterRight}>
                            <div className={styles.chapterBody}>
                                <p>본 프로젝트 목적은 단일 시각 기호 앞에서의 해독 권력(생물학적 조건 및 지식) 유무가 어떻게 양극화된 인지적 실재를 구축하는지 증명하고 아카이빙하는 것입니다. 표면적 인지에 머무는 A와 심층 정보를 해독하는 B의 인지적 격차를 데이터화해 인식론적 불균형을 시각적으로 가시화하고자 합니다.</p>
