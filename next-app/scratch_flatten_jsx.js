...
// Chapter 2
content = content.replace(
/ *<div className=\{styles\.chapterRight\} style=\{\{ position: 'relative' \}\}>\n[\s\S]*?정사 삼국지 \(Sanguozhi\)[\s\S]*?\{subSlide \+ 1\} \/ 2\{subSlide === 0 \? ' ↓' : ''\}\n *<\/div>\n *<\/div>/,
`                        <div className={styles.chapterRight}>
                            <div className={styles.chapterBody}>
...
// Chapter 6
content = content.replace(
/ *<div className=\{styles\.chapterRight\} style=\{\{ position: 'relative' \}\}>\n[\s\S]*?관도대전 \(200 AD\)[\s\S]*?\{subSlide \+ 1\} \/ 2\{subSlide === 0 \? ' ↓' : ''\}\n *<\/div>\n *<\/div>/,
`                        <div className={styles.chapterRight}>
                            <div className={styles.chapterBody}>
...
// Chapter 8
content = content.replace(
/ *<div className=\{styles\.chapterRight\} style=\{\{ position: 'relative' \}\}>\n[\s\S]*?촉의 주요 인물들은 연의에서[\s\S]*?\{subSlide \+ 1\} \/ 2\{subSlide === 0 \? ' ↓' : ''\}\n *<\/div>\n *<\/div>/,
`                        <div className={styles.chapterRight}>
                            <div className={styles.chapterBody}>
